...
// Cities controller
angular.module('cities').controller('CitiesController', ['$scope', '$stateParams', '$location', 'Authentication', 'Cities', 'Countries', 'States',
	function($scope, $stateParams, $location, Authentication, Cities, Countries, States) {
		...
		$scope.selectState = States.query();
